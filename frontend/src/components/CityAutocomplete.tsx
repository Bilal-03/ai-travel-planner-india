  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      <div className="relative">
        ...
        {isLoading && (
          <span className="absolute right-3 top-1/2 -translate-y-1/2">
            <svg className="animate-spin h-4 w-4 text-marigold" viewBox="0 0 24 24">
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute z-50 w-full mt-2 bg-surface border border-glass-border rounded-lg overflow-hidden shadow-lg animate-slide-up">
